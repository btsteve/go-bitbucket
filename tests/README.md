...
As per @btsteve's comment [here](https://github.com/btsteve/go-bitbucket/pull/122#issuecomment-758373984) tests are being changed so they can be run against both:
